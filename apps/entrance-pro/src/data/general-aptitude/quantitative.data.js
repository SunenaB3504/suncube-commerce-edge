        ...
        topics: [
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Common Fraction-Percentage Equivalents:\n1/2 = 50% | 1/3 = 33.33% | 1/4 = 25% | 1/5 = 20% | 1/6 = 16.66% | 1/8 = 12.5% | 1/9 = 11.11% | 1/11 = 9.09%\n\n2. Basic Formulas:\n- % Change = (Difference / Original Value) × 100\n  🏢 Real Life: Sneakers go from ₹2,000 to ₹2,500. Diff = ₹500. % Change = (500/2000) × 100 = 25% hike.\n- A is x% of B: (A / B) × 100\n  🏢 Real Life: Scored 40 out of 50. Score = (40/50) × 100 = 80%.\n- Net Successive Change = [a + b + (ab/100)]%\n  🏢 Real Life: Prices hiked 20%, then 10% discount. Change = 20 + (-10) + (-200/100) = +8% net hike.\n\n3. Finding Original Value (Reversed %):\n- Increased by R%: Orig = [V / (100 + R)] × 100\n  🏢 Real Life: Salary after 20% hike is ₹60k. Orig = [60k / 120] × 100 = ₹50k.\n- Decreased by R%: Orig = [V / (100 - R)] × 100\n  🏢 Real Life: Phone on 25% discount is ₹15k. Orig = [15k / 75] × 100 = ₹20k.\n\n4. The Overlap (Venn) Formula:\n- % failed in at least one = (% Fail A + % Fail B) - % Fail Both\n  🏢 Real Life: 30% fail Math, 25% English, 10% Both. Total failing = (30 + 25) - 10 = 45%.\n- % passed in both = 100% - % failed in at least one.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "The Priority Ladder:\n1. ( ) Brackets: Inner most first. [ { ( ) } ]\n  🏢 Real Life: Do the tasks 'inside the room' before leaving it. 5 × (2 + 3) means add first (5), then multiply (25).\n2. Of/Orders: Multiplication using 'of' or powers like 2³ and roots like √25.\n  🏢 Real Life: '20% of 500' is an ultra-strong bond. Solve it before splitting (dividing) the money.\n3. ÷ (Division) & × (Multiplication): If both are present, solve them from LEFT TO RIGHT.\n  🏢 Real Life: A conveyor belt of equal priority. 10 ÷ 2 × 5 means divide first (5), then multiply (25).\n4. + (Addition) & - (Subtraction): Solve them from LEFT TO RIGHT.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. The Product Rule: For two numbers (A and B), A × B = LCM × HCF.\n  🏢 Real Life: Two gears with 12 and 18 teeth. LCM = 36 (teeth to align), HCF = 6 (largest common group). 12 × 18 = 216, and 36 × 6 = 216.\n2. Fractions Rule:\n   - HCF of Fractions = HCF of Numerators / LCM of Denominators\n   - LCM of Fractions = LCM of Numerators / HCF of Denominators\n3. Remainder Shortcut: Smallest number divisible by X, Y, Z leaving remainder R = LCM(X, Y, Z) + R.\n  🏢 Real Life: Pack toys in boxes of 4, 5, or 6 and have 2 left over. LCM(4,5,6) = 60. You need 60 + 2 = 62 toys.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Time Shift Table:\n   - Present Age: X\n   - Age 'n' Years Ago: (X - n)\n   - Age 'n' Years Hence (Future): (X + n)\n  🏢 Real Life: If you are 20 today, in 10 years you will be 30. Everyone in the problem ages together! You must add +10 to EVERY person.\n2. Ratio of Ages: If the ratio of A:B is 3:4, assume their ages are 3k and 4k.\n  🏢 Real Life: A 3:4 ratio doesn't mean they are 3 and 4 years old. They could be 30 and 40 (k=10). Always lock the ratio with a 'k' multiplier.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Duplicate Ratio: a² : b² (e.g., 2:3 becomes 4:9).\n  🏢 Real Life: Enlarging a 2x3 photo to a square scale means the visual area ratio grows to 4:9.\n2. Sub-duplicate Ratio: √a : √b (e.g., 25:36 becomes 5:6).\n3. Proportions:\n   - Fourth Proportional of a, b, c: (b * c) / a.\n     🏢 Real Life: If 2 apples cost ₹10 (a, b), 4 apples (c) cost how much? (10 × 4) / 2 = ₹20.\n   - Third Proportional of a, b: b² / a.\n   - Mean Proportional (Geometric Mean) of a, b: √ab.\n     🏢 Real Life: The 'middle balance' between growth rates of 4x and 9x is √(4 × 9) = √36 = 6x.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Basic Average: (Sum of all observations) / (Number of observations).\n  🏢 Real Life: 3 friends have ₹10, ₹20, and ₹30. Pooled total is ₹60. ₹60 / 3 = ₹20 each.\n2. Weighted Average: (n1*A1 + n2*A2 + ...) / (n1 + n2 + ...).\n  🏢 Real Life: 10 people scored 50, 20 people scored 80. Avg is NOT 65. It's (500 + 1600) / 30 = 70. (It pulls towards the bigger group).\n3. Average of first 'n' natural numbers: (n + 1) / 2.\n4. Average Speed (Equal Distances): 2xy / (x + y).\n  🏢 Real Life: Drive to work at 60 km/h, drive home in traffic at 30 km/h. Avg speed = (2×60×30)/(60+30) = 40 km/h (Lower than the simple midpoint!).",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Simple Interest (SI): (P × R × T) / 100.\n  🏢 Real Life: Lend ₹1000 at 10% for 3 years. You get a flat rent of ₹100 every year = ₹300 total rent.\n2. CI Amount (A): P × (1 + R/100)^T.\n  🏢 Real Life: Invest ₹1000 at 10%. Year 1 you have 1100. Year 2 you earn 10% on 1100 (which is 110), making it 1210. Interest compounds!\n3. CI alone: Amount - Principal.\n4. Difference for 2 Years: P × (R/100)².\n  🏢 Real Life: The extra money earned on ₹1000 at 10% because of CI vs SI is 1000 × (10/100)² = ₹10 (The 'interest on interest' from Year 1).\n5. Relation: Amount = Principal + Interest.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Profit %: (Profit / CP) × 100.\n  🏢 Real Life: Buy a watch for ₹500, sell for ₹600. Profit = ₹100. % = (100/500) × 100 = 20%.\n2. Loss %: (Loss / CP) × 100.\n3. Selling Price (Profit): CP × (100 + P%) / 100.\n  🏢 Real Life: Buy a bike for ₹50k, want 10% profit. SP = 50k × 1.10 = ₹55k.\n4. Discount %: (Discount / MP) × 100.\n  🏢 Real Life: A ₹1000 tag is slashed to ₹800. Discount = ₹200. % = (200/1000) × 100 = 20% off.\n5. Selling Price (Discount): MP × (100 - D%) / 100.\n6. Profit with MP and Discount: Profit = SP - CP = (MP - Discount) - CP.",
            ...
            },
            {
                ...
                content: {
                    ...
                    formulaBank: "1. Basic: P(A) = n(E) / n(S).\n  🏢 Real Life: Winning a raffle with 10 tickets out of 1000. Prob = 10 / 1000 = 0.01 (1%).\n2. Coin Tossing: Total outcomes for 'n' coins = 2ⁿ.\n  🏢 Real Life: Flipping 3 coins gives 8 possible worlds (HHH, HHT...).\n3. Dice Throwing: Total outcomes for 'n' dice = 6ⁿ.\n4. Combinations (Choosing): nCr = n! / [r! * (n-r)!]. Use this to pick 2 balls from 5.\n  🏢 Real Life: Picking 2 team members from a group of 5 = 5C2 = (5×4)/2 = 10 unique teams.",
